          ...
          <div className='navbar-links flex justify-end gap-x-8'>
            ...
            {isLoggedIn ? (
              <button 
                ...
                className='bg-white text-center text-black rounded-3xl flex justify-evenly cursor-pointer mt-2 items-center w-30 h-11 hover:scale-105 hover:bg-gray-100 transition-all'
              >
                Log out 
              </button>
            ) : (
