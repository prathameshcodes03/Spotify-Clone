...
const Album = () => {
  return (
    <div className='album-panel h-170 w-5xl bg-gray-900 rounded-2xl ml-105 my-[-42.5rem] overflow-hidden flex flex-col'>
      ...
      <div className="album-content px-6 py-4 text-white overflow-y-auto flex-1 min-h-0">
