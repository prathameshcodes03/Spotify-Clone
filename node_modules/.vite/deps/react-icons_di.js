import {
  GenIcon
} from "./chunk-PS2ETK4H.js";
import "./chunk-YSCK7JR7.js";

// node_modules/react-icons/di/index.mjs
function DiZend(props) {
...
function DiTerminalBadge(props) {
...
function DiStackoverflow(props) {
...
function DiSmashingMagazine(props) {
...
function DiMootoolsBadge(props) {
...
function DiMaterializecss(props) {
...
function DiKrakenjsBadge(props) {
...
function DiHtml5Multimedia(props) {
...
function DiHtml5DeviceAccess(props) {
...
function DiHtml5Connectivity(props) {
...
function DiGoogleAnalytics(props) {
...
function DiGoogleCloudPlatform(props) {
...
function DiGitPullRequest(props) {
...
function DiCreativecommonsBadge(props) {
...
function DiCreativecommons(props) {
...
function DiAngularSimple(props) {
...
//# sourceMappingURL=react-icons_di.js.map
